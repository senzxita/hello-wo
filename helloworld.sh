...
# 2. Move the extracted file into a Documents folder
...
# 4. To open index.html file in your Chrome browser, use "google-chrome index.html" in a linux system 
# 5. For Mac Os, you can use --> open -a "Google Chrome" index.html
